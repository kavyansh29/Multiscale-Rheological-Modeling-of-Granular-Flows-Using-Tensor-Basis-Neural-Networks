...
class GranularTBNN(nn.Module):
    ...
    def __init__(self, structure):
        super().__init__()
        self.coeff_mlp = _build_mlp(3, 3, structure.num_layers, structure.num_nodes)
...
def main():
    ...
    torch.save({
        ...
        'coeffs':        coeffs,
        'mask':          mask,
    }, '/Users/kavyanshrajsingh/Desktop/Data/tbnn_representation_theorem.pt')
    print("\nSaved → tbnn_representation_theorem.pt")
